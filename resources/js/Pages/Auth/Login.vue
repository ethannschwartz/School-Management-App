...
import BreezeCheckbox from '@/Components/Modules/Checkbox.vue';
    ...
    <BreezeGuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <BreezeButton class="ml-4 bg-teal-600" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Log in
                </BreezeButton>
            </div>
        </form>
