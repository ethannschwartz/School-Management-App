        ...
        <div class="px-8 lg:px-16 py-8 lg:py-16">
            <div class="h-[600px] flex bg-white shadow-lg">
                ...
                <form @submit.prevent="storeProfileDetails" class="block m-12">
                    ...
                    <input type="text" placeholder="Institution" class="block mb-4"  />
                    <input type="text" placeholder="Subject" class="block mb-4"  />
...
const storeProfileDetails = () => {
    profileDetails.post(route('teachers.profile.store', props.user), {
        onSuccess: () => {
